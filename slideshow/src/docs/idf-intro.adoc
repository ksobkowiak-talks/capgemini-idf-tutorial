...
* Accelerators -- Demo
* Immediate on AWS -- Demo

// -------------------------------------------------------------------------------
== Capgemini Immediate Digital Framework
[.centering]
--
image:images/immediate.png[width="30%"]
--
...
== Immediate in Action - Local

* Explore selected accelerators running locally using Virtual Box and Vagrant

// -------------------------------------------------------------------------------

== Immediate in Action - AWS
...
[.centering]
--
image:images/immediate-in-action-aws-1.png[width="80%"]
--
...
[.centering]
--
image:images/immediate-in-action-aws-2.png[width="80%"]
--
...
[.centering]
--
image:images/immediate-in-action-aws-3.png[width="80%"]
--
